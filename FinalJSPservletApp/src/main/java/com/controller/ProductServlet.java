...
public class ProductServlet extends HttpServlet {
	...
	public void init()     //create constructor //life cycle of servlet
	{            
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 session.setAttribute("data", lstproduct);//key & object
		 
		 pw.print("<h1>Do you want to add more product click yes or no</h1><br>");
