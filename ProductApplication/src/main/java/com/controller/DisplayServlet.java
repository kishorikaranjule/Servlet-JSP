...
public class DisplayServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        pw.println("<h1 class='display-4 mt-4'><center>Final Product List</center></h1>");
        ...
        if (lstProd != null && !lstProd.isEmpty()) {
            ...
            pw.println("<h3>Bill Time: " + formattedTime + "</h3>");
		...
		PrintWriter pw = response.getWriter();
        HttpSession session = request.getSession(true);
        List<Product> lstProd = (List<Product>) session.getAttribute("data");
